...
namespace GerenciadorHotel.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Configurar campos personalizados - cadastro público é sempre Hóspede
                user.Nome = Input.Nome;
                user.Sobrenome = Input.Sobrenome;
                user.NivelAcesso = NivelAcesso.Hospede; // Fixo para cadastro público
                user.Ativo = true;
                ...
                if (result.Succeeded)
                {
                    ...
                    // Adicionar role de Hospede automaticamente
                    ...
                    var callbackUrl = Url.Page(
                        ...
                        pageHandler: null,
                        values: new { area = "Identity", userId = newUserId, code = confirmationCode, returnUrl = returnUrl },
